...
async function runMigration() {
    ...
    for (let i = 0; i < services.length; i++) {
        ...
        console.log(`Created service tab: ${s.label}`);
    }
    ...
    for (let i = 0; i < projects.length; i++) {
        ...
        await client.create({
            ...
            category: p.category,
            image: p.image,
            featured: i < 4, // first 4 are featured based on your original code
            order: i + 1
        });
    ...
    for (let i = 0; i < heroSlides.length; i++) {
        ...
        console.log(`Created hero slide: ${h.title}`);
    }
    ...
    console.log('Migration complete! All your data is now in Sanity.');
}
