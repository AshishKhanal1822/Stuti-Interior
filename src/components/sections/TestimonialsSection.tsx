...
import { useSanityTestimonials } from "@/hooks/useSanity";
import { testimonials as localTestimonials } from "@/constants/testimonials";
...
const TestimonialsSection = () => {
  ...
  const { testimonials: sanityTestimonials, loading } = useSanityTestimonials();
  const testimonials = sanityTestimonials.length > 0 ? sanityTestimonials : localTestimonials;
